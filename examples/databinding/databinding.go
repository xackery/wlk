...
func main() {
	walk.AppendToWalkInit(func() {
		walk.FocusEffect, _ = walk.NewBorderGlowEffect(wcolor.RGB(0, 63, 255))
		walk.InteractionEffect, _ = walk.NewDropShadowEffect(wcolor.RGB(63, 63, 63))
		walk.ValidationErrorEffect, _ = walk.NewBorderGlowEffect(wcolor.RGB(255, 0, 0))
	})
