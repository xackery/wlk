...
func (wgeb *widgetGraphicsEffectBase) create(color wcolor.Color) error {
	wgeb.color = color
	return nil
}
...
func NewBorderGlowEffect(color wcolor.Color) (*BorderGlowEffect, error) {
...
func NewDropShadowEffect(color wcolor.Color) (*DropShadowEffect, error) {
