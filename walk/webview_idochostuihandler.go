...
func init() {
	AppendToWalkInit(func() {
		webViewIDocHostUIHandlerVtbl = &win.IDocHostUIHandlerVtbl{
			...
			//GetOverrideKeyPath:     syscall.NewCallback(webView_IDocHostUIHandler_GetOverrideKeyPath),
			//GetDropTargetContextMenu: syscall.NewCallback(webView_IDocHostUIHandler_GetDropTargetContextMenu),
		}
	})
}
